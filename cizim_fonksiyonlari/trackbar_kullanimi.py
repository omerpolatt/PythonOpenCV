...
cv.createTrackbar("Mavi","Goruntu",0,255,fonk) # treackbar oluşturma fonk
cv.createTrackbar("Yesil","Goruntu",0,255,fonk)
cv.createTrackbar("Kirmizi","Goruntu",0,255,fonk)

while True:
    cv.imshow("Goruntu",goruntu)
    mavi=cv.getTrackbarPos("Mavi","Goruntu")  # mavi değişkenine getTrackbarPos() fonk ile treckbardan alınan değer
#atanmakta bu şekilde işlemde kullanılması sağlanır değerlerin
